...
# ---------------------------------------------------------------------------- #
x1, y1 = np.loadtxt( "rate/rate_average.dat", unpack = True )
...
##y1ticks = [0.03,0.1,0.3,1,3,10,30,100]
...
ax1.plot( x1[ord1], y1[ord1], lw=1.2, color='0.5',
    label=r'without light meson contributions', dash_capstyle='round')
